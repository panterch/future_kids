...
describe MentorMatching do
  context 'confirmed' do
    ...
    it 'confirms matching and declines others' do
      ...
      expect{ mentor_matching.confirmed }.to change { change { ActionMailer::Base.deliveries.count }.by(2) }
  ...
  context 'declined' do
    ...
    it 'declines matching' do
      expect{ mentor_matching.declined }.to change { change { ActionMailer::Base.deliveries.count }.by(1) }
